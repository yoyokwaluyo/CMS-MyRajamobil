    ...
    <form method="POST" action="#" class="space-y-4">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <select name="model" class="form-control form-validation" id="model" required="">
                    <option value="">Pilih</option>
                    <option label="5000" value="0" selected>5000 km</option>
                    <option label="10000" value="1">10000 km</option>
                </select>
            </div>
            <div>
        ...
        <div class="md:col-span-2 md:pr-6 mt-10 flex flex-col gap-4 items-center justify-center">
            ...
            <a href="{{ route('requestservice', app()->getLocale()) }}" class="buttons-outline py-2.5 w-full md:w-1/2 rounded-md text-base text-center hover:bg-gray-500 hover:text-white">Kembali</a>
        </div>
    </form>
</div>
